    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				{
                    "regex": /^[0-9a-zA-Z\ \-\+]+$/,
                    "alertText": "Dozwolone tylko cyfry i znaki "-+""
                },
                "minSize": {
                    "regex": "none",
                ...
                {
                    "regex": /^[a-zA-ZąćęłńóśźżĄĆĘŁŃÓŚŹŻ\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Tylko litery, polskie znaki i ' _,`.'^-' Dozwolone znaki"
                },
				...
				{
                    "regex": /^[0-9a-zA-ZąćęłńóśźżĄĆĘŁŃÓŚŹŻ\ \_\,\`\.\'\^]+$/,
