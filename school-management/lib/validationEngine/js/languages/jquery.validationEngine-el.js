    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				{
                    "regex": /^[0-9a-zA-Z\ \-\+]+$/,
                    "alertText": "Lubatud on ainult numbrid ja '+' märgid"
                },
                "dateRange": {
                    "regex": "none",
                ...
                "email": {
                    ...
                    "regex": /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([A-Za-zΑ-Ωα-ωίϊΐόάέύϋΰήώ\-0-9]+\.)+[A-Za-zΑ-Ωα-ωίϊΐόάέύϋΰήώ]{2,}))$/,
                ...
                {
                    "regex": /^[a-zA-Zα-ωΑ-ΩάέήίόύώΆΈΉΊΌΎΏϊϋΪΫΐΰἈ-Ἦἰ-ώ\_\ \,\`\.\'\^\-]+$/,
